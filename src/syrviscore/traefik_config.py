...
def generate_traefik_dynamic_config() -> str:
    ...
    # Generate Synology services config if NAS_IP is set
    synology_routers = ""
    synology_services = ""
    if nas_ip:
        synology_routers = generate_synology_routers_config(domain, nas_ip)
        synology_services = generate_synology_services_config(nas_ip)
